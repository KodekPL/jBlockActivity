                ...
                if (getExtraData() != null) {
                    if (entity instanceof LivingEntity) {
                        ...
                        if (data.getMaxHealth() != null) {
                            lEntity.setMaxHealth(data.getMaxHealth());
                        }

                        if (data.getHealth() != null) {
                            lEntity.setHealth((data.getHealth() > lEntity.getMaxHealth()) ? lEntity.getMaxHealth() : data.getHealth());
                        }

                        if (data.getCustomName() != null) {
                            lEntity.setCustomName(data.getCustomName());
                        }

                        if (data.isCustomNameVisible() != null) {
                            lEntity.setCustomNameVisible(data.isCustomNameVisible());
                        }

                        if (data.getCanPickupItems() != null) {
                            lEntity.setCanPickupItems(data.getCanPickupItems());
                        }

                        if (data.getRemoveWhenFarAway() != null) {
                            lEntity.setRemoveWhenFarAway(data.getRemoveWhenFarAway());
                        }
                        ...
                        if (entityEq != null) {
                            ...
                            if (entityEq[0] != null) {
                                lEntity.getEquipment().setItemInHand(entityEq[0]);
                            }

                            if (dropChances[0] != null) {
                                lEntity.getEquipment().setItemInHandDropChance(dropChances[0]);
                            }

                            if (entityEq[1] != null) {
                                lEntity.getEquipment().setHelmet(entityEq[1]);
                            }

                            if (dropChances[1] != null) {
                                lEntity.getEquipment().setHelmetDropChance(dropChances[1]);
                            }

                            if (entityEq[2] != null) {
                                lEntity.getEquipment().setChestplate(entityEq[2]);
                            }

                            if (dropChances[2] != null) {
                                lEntity.getEquipment().setChestplateDropChance(dropChances[2]);
                            }

                            if (entityEq[3] != null) {
                                lEntity.getEquipment().setLeggings(entityEq[3]);
                            }

                            if (dropChances[3] != null) {
                                lEntity.getEquipment().setLeggingsDropChance(dropChances[3]);
                            }

                            if (entityEq[4] != null) {
                                lEntity.getEquipment().setBoots(entityEq[4]);
                            }

                            if (dropChances[4] != null) {
                                lEntity.getEquipment().setBootsDropChance(dropChances[4]);
                            }
                        }
                    }
                    ...
                    if (entity instanceof Ageable) {
                        ...
                        if (data.isAgeLock() != null) {
                            ageable.setAgeLock(data.isAgeLock());
                        }
                    ...
                    if (!getExtraData().isNull()) {
                        if (getEntityId() == 50) {
                            ...
                            if (data.isVillager() != null) {
                                zombie.setVillager(data.isVillager());
                            }
                            ...
                            if (data.getCollarColor() != null) {
                                wolf.setCollarColor(data.getCollarColor());
                            }
                            ...
                            if (data.getCatType() != null) {
                                ocelot.setCatType(data.getCatType());
                            }
                            ...
                            if (data.getVariant() != null) {
                                horse.setVariant(data.getVariant());
                            }
                            ...
                            if (data.getMaxDomestication() != null) {
                                horse.setMaxDomestication(data.getMaxDomestication());
                            }

                            if (data.getDomestication() != null) {
                                horse.setDomestication(data.getDomestication());
                            }
                            ...
                            if (data.isCarryingChest() != null) {
                                horse.setCarryingChest(data.isCarryingChest());
                            }

                            final ItemStack[] invContent = data.getInventory(getWorld());

                            if (invContent != null) {
                                if (invContent[0] != null) {
                                    horse.getInventory().setSaddle(invContent[0]);
                                }

                                if (invContent[1] != null) {
                                    horse.getInventory().setArmor(invContent[1]);
                                }
